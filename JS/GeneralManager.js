...
GeneralManager.defaultBarSettings = function(){
    ...
    */
    ...
    cd.ortho2AxisLabel_textStyle = "#999999";
    cd.ortho2AxisDesiredTickCount = 2;
    cd.ortho2AxisGrid = true;
    cd.ortho2AxisGrid_strokeStyle = function() {
        return (this.index !== this.scene.parent.childNodes.length - 1) ? "#CCC" : "#CCC";
    };
    cd.ortho2AxisGrid_lineWidth = function() {
        return (this.index !== this.scene.parent.childNodes.length - 1) ? 1 : 1;
    };;
    cd.orthoAxisGrid_visible = false;
}; 
