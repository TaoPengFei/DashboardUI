...
steelwheels.productLines_colorMap = function(){
    ...
    var colors = ["#2361AC","#0B7CC2","#29A7E2","#A3D7D5","#8EC21F","#AE6409","#FB96C2","#66C2A5","#5C9FBC","#3E83B7","#005CA7","#F62760","#585959","#FF9322","#FFFC36","#82D900","#974C48","#3A1D5C","#FF2D2E","#272727","#584D05","#613131","#FFDAC8","#E6C9FE","#CDCD98"];
    var jsonData="";
